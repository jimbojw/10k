...
(function(p){function r(a){var b,e,c,g=0,f,d={};e=a.split(m);a=0;for(b=e.length;a<b;a++){g++;c=e[a];f=c.toLowerCase();if(c.length>2&&!i[f]){(c=d[f])||(c=d[f]=[]);c[c.length]=g}}return d}function k(a,b,e){if((e=""+e)&&/[a-z]/i.test(e)){e=r(e);var c,g,f;for(c in e){g=o("W-"+c)||{};(f=g[a])||(f=g[a]={});f[b]=e[c];h("W-"+c,g)}}}var o=p.get,h=p.set,m=/[^0-9a-z_]+/i,i=p.stop;p.extract=r;p.indexer=function(a){var b,e=o("URL-"+a.url);if(e){b=e.id;if(a.content!==e.text||a.title!==e.title)h("URL-"+a.url,{id:b,
text:a.content,title:a.title})}else{b=o("COUNT")||0;h("ID-"+b,a.url);h("COUNT",b+1);h("URL-"+a.url,{id:b,text:a.content,title:a.title})}k(b,"s",a.selection);k(b,"t",a.title);k(b,"p",a.priority);k(b,"c",a.content)}})(window["10kse"],window);
(function(p,r,k,o){var h=o.get,m=o.set,i=r.location.href;h=h("K");if(!h){h=Math.random();m("K",h)}i=JSON.stringify(i.replace(/#.*|$/,"#"+h));m="javascript:("+(function(a,b,e){var c=a["10kse"];c||(c=a["10kse"]={});if(c.scanner)return c.scanner();a.addEventListener("message",function(d){if(e.substr(0,d.origin.length)===d.origin){c.scanner=new Function(d.data);c.scanner()}},false);var g=c.iframe=b.createElement("iframe");a=g.style;g.setAttribute("src",e);a.width=a.height="1px";a.top=a.left="-2px";a.border=
"none";a.position="absolute";var f=false;g.onload=g.onreadystatechange=function(){if(!f&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){f=true;g.onload=g.onreadystatechange=null;g.contentWindow.postMessage("script",e)}};b.body.appendChild(g)}+"").replace(/\/\*[\s\S]*?\*\//g,"").replace(/\s+/g," ")+")(window,document,"+i+")";k("#add").attr("href",m).click(function(a){a.preventDefault();alert("1. Drag this link to your bookmarks,\n2. Navigate to another page,\n3. Click the bookmarklet to add that page to your search engine.")});
