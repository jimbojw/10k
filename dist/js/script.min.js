...
(function(p,r,k,o){var h=o.get,m=o.set,i=r.location.href;h=h("K");if(!h){h=Math.random();m("K",h)}i=JSON.stringify(i.replace(/#.*|$/,"#"+h));k("#add").attr("href",("javascript:("+function(a,b,e){var c=a["10kse"];c||(c=a["10kse"]={});if(c.scanner)return c.scanner();a.addEventListener("message",function(d){if(e.substr(0,d.origin.length)===d.origin){c.scanner=new Function(d.data);c.scanner()}},false);var g=c.iframe=b.createElement("iframe");a=g.style;g.setAttribute("src",e);a.width=a.height="1px";a.top=
a.left="-2px";a.border="none";a.position="absolute";var f=false;g.onload=g.onreadystatechange=function(){if(!f&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){f=true;g.onload=g.onreadystatechange=null;g.contentWindow.postMessage("script",e)}};b.body.appendChild(g)}+")(window,document,"+i+")").replace(/\s+/g," ")).click(function(a){a.preventDefault();alert("1. Drag this link to your bookmarks,\n2. Navigate to another page,\n3. Click the bookmarklet to add that page to your search engine.")});
