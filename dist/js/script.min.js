...
d=c.length;if(m)if(g===k){if(d>50)c=c.substr(0,46)+" ..."}else if(g===0){if(d>50)c="... "+c.substr(d-50-4)}else if(d>100)c=c.substr(0,47)+" ... "+c.substr(d-50-3);i[i.length]=c;a+=c.length;if(g<k){c=f[b];i[i.length]="<b>"+h.substr(b,c.length)+"</b>";a+=c.length;o=b+c.length}g++}if(a>=200&&g<=k)i[i.length]=" ...";return i.join("")}})(window["10kse"],jQuery);
